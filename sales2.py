...
with header:
	st.title('Knox Business Sales Analysis')
	...
	with visualization:
		...
		st.subheader("General Overview of Sales & Performance")
		...
		img = Image.open("./image/1-1.jpg")
		st.image(img)

		st.subheader("Overview of Sales & Performance by State")
		imd = Image.open("./image/1-2.jpg")
		st.image(imd)
		...
		url = 'To view the interactive live dashboard on powerbi service, click  [Dashboard](https://app.powerbi.com/view?r=eyJrIjoiMWM2NWU0MTQtMTY3My00MjljLThlOGEtMmEwZmI4YzkzNTdhIiwidCI6IjhlOTVjNGQxLWRiZmQtNGFmNS1iODA2LTIwMGJkZDY2ZDJjZSJ9)'
